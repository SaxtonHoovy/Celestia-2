...
country = {
	...
	COLONIZATION_DAYS_FOR_INITIAL_INVESTMENT = 60,
	COLONIZATION_PROTECTORATE_PROVINCE_MAINTAINANCE = 10,
	COLONIZATION_COLONY_PROVINCE_MAINTAINANCE = 15,
...
military = {
	...
	LEADER_MAX_RANDOM_PRESTIGE = 0.00, -- max percent of prestige, when randomizing stats for leaders.
	...
	LEADER_PRESTIGE_LAND_GAIN =2.0 , -- extra speed gain on prestige for land combat
	LEADER_PRESTIGE_NAVAL_GAIN =2.0 , -- extra speed gain on prestige for naval combat
...
pops = {
	...
	STATE_CREATION_ADMIN_LIMIT = 0.000000,
